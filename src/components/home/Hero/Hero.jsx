      ...
      <section className='hero'>
        <div className='container'>
          <h1>
            ...
            <br />
            <label>
              Collections, <span>New arrivals </span> with latest trend.
            </label>
          </h1>
          <p>High-quality collection with latest design and trends in 100 categories.</p>
          ...
          <p>Examples: Earrings, Rings, Bracelets etc....</p>
        </div>
      </section>
    </>
  )
